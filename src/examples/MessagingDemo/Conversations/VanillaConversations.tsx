...
import { useVanillaConversations } from "examples/MessagingDemo/Conversations/useVanillaConversations";
import { memo, ReactElement } from "react";
import styled from "styled-components";

const MemoizedContactListItem = memo(ContactListItem);

export const VanillaConversations = (): ReactElement => {
    const { conversations, onChangeSearch, onClickConversation, search, selectedReceiverName } =
        useVanillaConversations();
