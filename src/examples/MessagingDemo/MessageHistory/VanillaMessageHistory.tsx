...
import { useVanillaMessageHistory } from "examples/MessagingDemo/MessageHistory/useVanillaMessageHistory";
import { createRef, memo, ReactElement, useEffect, useMemo } from "react";
import styled from "styled-components";

const MemoizedMessageLine = memo(MessageLine);

export const VanillaMessageHistory = (): ReactElement => {
    const { isLoading, messages, numConversations, senderName } = useVanillaMessageHistory();
