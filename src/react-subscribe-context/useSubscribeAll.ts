...
export function useSubscribeAll<TState, TKey extends keyof TState & string>(
    Context: Context<ControlState<TState>>,
    key: TKey
): UseSubscribeValueReturn<TState, TKey>;

export function useSubscribeAll<TState>(
    Context: Context<ControlState<TState>>,
    key?: undefined | null
): UseSubscribeStateReturn<TState>;

export function useSubscribeAll<TState extends object, TKey extends keyof TState & string>(
    Context: Context<ControlState<TState>>,
